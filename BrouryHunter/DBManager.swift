...
class DBManager{
    ...
    func encuentraTodosLos (nombreEntidad: String) -> NSArray {
    ...
    // ppara màs de un argumento el identificador del paràmetro se debe usar como etiqueta al
    //al invocar al mètodo
    func encuentraTodosLosFiltrados (nombreEntidad: String, _ filtradosPor: NSPredicate) -> NSArray {
        // es la llamada de un  qry
        let elQry:NSFetchRequest = NSFetchRequest()
    ...
    lazy var managedObjectModel:NSManagedObjectModel? = {
        ...
        let modeURL = NSBundle.mainBundle().URLForResource("BountyHunterModel", withExtension: "momd")
